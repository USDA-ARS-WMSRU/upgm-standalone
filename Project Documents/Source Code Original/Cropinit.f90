SUBROUTINE cropinit(isr,aepa,aifs,antes,antss,blstrs,boots,browns,callgdd,     &
            ...
            & dummy1,dummy2,ears,ecanht,egdd,emrgflg,ems,endlgs,epods,ergdd,   &
            & eseeds,first7,fps,fullbs,gddtbg,germgdd,germs,ggdd,gmethod,gpds, &
            & growth_stress,halfbs,heads,hrs,ies,ies2,infls,joints,lf1s,lf12s, &
            & lf2s,lf3s,lf4s,lf8s,mats,maxht,mffls,milks,mpods,mseeds,opens,   &
            & pchron,phenolflg,seedsw,silks,soilwat,srs,tbase,tis,toptlo,      &
...
! Local variables
!
INTEGER :: d,dn,i,idx,mo,newrow,row,y
!
